...
__all__ = ['whiterun_location_triggers', 'windhelm_location_triggers', 'markarth_location_triggers', 'winterhold_location_triggers', 'solitude_location_triggers', 'global_story_triggers']
