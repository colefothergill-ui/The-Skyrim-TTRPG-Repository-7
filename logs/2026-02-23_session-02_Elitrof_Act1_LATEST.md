---
## Mid-Session Checkpoint (Dustman's Cairn Exterior)
**Scene ID:** act1_scene_009_dustmans_departure_dawn  
**Location:** Dustman's Cairn (Exterior)  
...
- Harbinger's Charge (sanctioned Circle trial)
- Trial of the Lone Bear (solo-run pressure; compels likely)
- Harbinger's Horn Toggle issued (emergency backup)

### Seeds / Threat Beats (next 1–2 scenes)
- **Dungeon mix:** Draugr (tomb guardians) + Silver Hand presence (use Bandit Marauder statline as Silver Hand hunters)
